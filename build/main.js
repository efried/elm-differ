// elm-watch hot {"version":"1.2.3","targetName":"My target name","webSocketPort":53549,"webSocketToken":"93146fbf-c216-49b9-aeec-5d302e005a7d"}
"use strict";
(() => {
...
var $author$project$Main$listOfListDecoder = $elm$json$Json$Decode$list(
...
var $author$project$Main$matrixDecoder = A2(
	...
	$elm$json$Json$Decode$decodeValue(
		A2(
			$elm$json$Json$Decode$map,
			$elm$core$Maybe$withDefault($Punie$elm_matrix$Matrix$empty),
			A2($elm$json$Json$Decode$map, $Punie$elm_matrix$Matrix$fromLists, $author$project$Main$listOfListDecoder))),
	$elm$core$Result$withDefault($Punie$elm_matrix$Matrix$empty));
var $author$project$Main$receiveLCSMatrix = _Platform_incomingPort('receiveLCSMatrix', $elm$json$Json$Decode$value);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$receiveLCSMatrix(
		A2($elm$core$Basics$composeR, $author$project$Main$matrixDecoder, $author$project$Main$MatrixReceived));
};
var $elm$core$String$fromList = _String_fromList;
var $author$project$Main$getLCS = _Platform_outgoingPort(
	'getLCS',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
...
var $author$project$Main$getCharacter = F2(
	function (idx, val) {
		return A2(
			$elm$core$Array$get,
			idx,
...
var $author$project$Main$getLongestCommonSubstring = F3(
	function (firstString, secondString, matrix) {
		var initial = {
			first: $elm$core$String$length(firstString),
			matrix: matrix,
			result: _List_Nil,
			second: $elm$core$String$length(secondString)
		};
		var getNextValues = function (acc) {
			var secondChar = A2($author$project$Main$getCharacter, acc.second - 1, secondString);
			var firstChar = A2($author$project$Main$getCharacter, acc.first - 1, firstString);
			var _v0 = _Utils_Tuple2(firstChar, secondChar);
			_v0$2:
			while (true) {
				if (_v0.a.$ === 'Nothing') {
					if (_v0.b.$ === 'Nothing') {
					...
					if (_v0.b.$ === 'Just') {
						var a = _v0.a.a;
						var b = _v0.b.a;
						return _Utils_eq(a, b) ? _Utils_update(
							acc,
							{
								first: acc.first - 1,
								result: A2(
							...
							A2(
								...
								0,
								A3($Punie$elm_matrix$Matrix$get, acc.first - 1, acc.second, acc.matrix)),
							A2(
								$elm$core$Maybe$withDefault,
								0,
								A3($Punie$elm_matrix$Matrix$get, acc.first, acc.second - 1, acc.matrix))) < 1) ? _Utils_update(
							acc,
							{second: acc.second - 1}) : _Utils_update(
							acc,
							{first: acc.first - 1}));
					} else {
						break _v0$2;
		...
		var lcsReducer = function (values) {
			lcsReducer:
			while (true) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Main$getLCS(
						{first: model.firstWord, second: model.secondWord}));
		}
	});
var $author$project$Main$FirstWord = function (a) {
	return {$: 'FirstWord', a: a};
};
var $author$project$Main$SecondWord = function (a) {
...
var $author$project$Main$viewPrettyMatrix = function (matrix) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			...
			A2(
				...
				A2(
					...
					'\n',
					A2($Punie$elm_matrix$Matrix$pretty, $elm$core$String$fromInt, matrix)))));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4($author$project$Main$viewInput, 'text', 'First Word', model.firstWord, $author$project$Main$FirstWord),
						A4($author$project$Main$viewInput, 'text', 'Second Word', model.secondWord, $author$project$Main$SecondWord),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$SubmitLCS)
							]),
						_List_fromArray(
							[
